...
(function ($, _, undefined) {
    ...
    var defaultSettings = {
        ...
        onDataRequest_2 : $.noop, //Function where we can search the data
    ...
    //Main class of MentionsInput_2 plugin
    var MentionsInput_2 = function (settings) {
        ...
        function doSearch(query) {
            ...
            if (query && query.length && query.length >= settings.minChars) {
                //Call the onDataRequest_2 function and then call the populateDropDrown
                settings.onDataRequest_2.call(this, 'search', query, function (responseData) {
        ...
        // Public methods
        return {
            //Initializes the mentionsInput_2 component on a specific element.
    ...
    $.fn.mentionsInput_2 = function (method, settings) {
        ...
        return this.each(function () {
            var instance = $.data(this, 'mentionsInput_2') || $.data(this, 'mentionsInput_2', new MentionsInput_2(settings));
